...
Before any demonstration is shown, the painter should see the proposed scope: target passage, scope class, protected passages, and teaching purpose.

An edit request should usually be followed by repaint guidance, not another edit request.
...
Scope should be visible before correction. It tells the painter what will change, what will not change, and why the demonstration is limited.
...
- no tightening of ambiguous or atmospheric passages merely for clarity.
...
- and useful enough to return the painter to repaint planning.
...
edit_request:
  ...
  intervention_scope:
    ...
    painter_orientation: Only the middle-distance shadow family is being tested; the focal light and sky wash remain untouched.

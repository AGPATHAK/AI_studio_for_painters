...
This document captures reusable prompt modules for AI-assisted critique and correction workflows.

These primitives are intended to:
- standardize critique behavior,
- improve prompt consistency,
- and support future modular AI systems.

...
- reveal scope before demonstration,
- stage critique surfaces progressively,
...
The schema supports progressive reveal. It should not imply that every field appears to the painter at once.

Preferred surface order:
1. overall read and priority diagnosis,
2. intervention scope,
3. teaching point,
4. optional demonstration or comparison,
5. repaint guidance.

Secondary critique fields may remain hidden until requested. The schema may contain more than the first surface shows.
...
Before any demonstrative critique, scope should orient the painter:
- where the intervention is aimed,
- what remains untouched,
- why the scope is limited,
- and what visual lesson it serves.
...
critique:
  ...
  intervention_scope:
    ...
    painter_orientation: The demonstration would quiet competing passages without changing the central subject.
